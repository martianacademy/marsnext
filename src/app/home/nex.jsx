    ...
    <group {...props} dispose={null}>
      <group name="Scene">
        <group name="space-modelglb" userData={{ name: "space-model.glb" }}>
          <group name="AmbientLight" userData={{ name: "AmbientLight" }} />
          <group name="space-modelglb_1" userData={{ name: "space-model.glb" }}>
            <group
                ...
                >
                  ...
                  >
                    <mesh
                      ...
                      morphTargetDictionary={nodes.grass.morphTargetDictionary}
                      morphTargetInfluences={nodes.grass.morphTargetInfluences}
                  ...
                  >
                    <mesh
                      ...
                      userData={{ targetNames: ["0", "1"], name: "mesh_17" }}
                    />
                  </group>
                  <group
                    name="Cylinder001_21"
                  ...
                  >
                    <mesh
                      ...
                      morphTargetDictionary={nodes.smoke.morphTargetDictionary}
                      morphTargetInfluences={nodes.smoke.morphTargetInfluences}
                  ...
                  >
                    ...
                    >
                      ...
                      <group name="brows_81" userData={{ name: "brows_81" }} />
                      <group name="eyes_82" userData={{ name: "eyes_82" }} />
                      <group name="glass_83" userData={{ name: "glass_83" }} />
                      ...
                      <group name="scarf_91" userData={{ name: "scarf_91" }} />
                      <group name="torso_92" userData={{ name: "torso_92" }} />
                      <skinnedMesh
                        name="Object_50"
        ...
        <group
          ...
          position={[3, 3.9, -0.05]}
          userData={{ name: "HemisphereLight" }}
        />
        <directionalLight
          name="DirectionalLight"
          intensity={1}
          decay={2}
          position={[0.12, 8.53, 6.24]}
          rotation={[-2.85, -0.45, 1.79]}
          userData={{ name: "DirectionalLight" }}
        >
          <group position={[0, 0, -1]} />
        </directionalLight>
